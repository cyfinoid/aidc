...
aidc::ensure_host_config_dirs() {
  ...
  mkdir -p "$AIDC_EMPTY_ROOT/claude" "$AIDC_EMPTY_ROOT/codex" "$AIDC_EMPTY_ROOT/opencode" "$AIDC_EMPTY_ROOT/opencode-data" "$AIDC_EMPTY_ROOT/grok" "$AIDC_EMPTY_ROOT/omp" "$AIDC_EMPTY_ROOT/cursor" "$AIDC_EMPTY_ROOT/clipboard"
